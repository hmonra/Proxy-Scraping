...
print("RUN Instancia 4")

# Opciones de navegación
options = webdriver.ChromeOptions()

#Proxy 4
hostname = "195.114.202.189"
port = "58542"
...
def comprar():
    ...
    if driver.current_url == 'https://www.pccomponentes.com/cart/':
        telegram_bot_sendtext("BOT 4 - ❌ Intento de compra realizado, sin stock ❌:  " + nombre_producto)
        print("Compra no realizada, el stock ha volado... :(")
    else:
        if driver.current_url == 'https://www.pccomponentes.com/cart/summary':
            telegram_bot_sendtext("BOT 4 - ❌ Intento de compra realizado ❌:  " + nombre_producto)
            print("Compra no realizada, algo ha fallado... :(")
        else:
            telegram_bot_sendtext("BOT 4 - ✅ Compra realizada ✅:  " + nombre_producto)
...
while True:
    ...
    try:
        ...
        if "0" not in cuadro_cesta:
            ...
            print("INSTANCIA 4 - 🔴 Ninguna gráfica en stock...      Hora:", current_time)
            print("Script corriendo desde: ", hora_inicial)
            driver.minimize_window()
            os.system('python scrap3.py')
    except TimeoutException or WebDriverException:
        print("")
        print("Url Time out..")
        print("URL: https://www.pccomponentes.com/lista-de-deseos/carrito/zXDqDGSeJHyy7x")
        driver.delete_all_cookies()
        print("Borrando todas las cookies...")
        print("Volviendo a escanear...")
        print("")
